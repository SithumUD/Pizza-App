...
public class UserManageActivity extends AppCompatActivity implements UserAdapter.OnUserClickListener {
    ...
    private AutoCompleteTextView spinnerUserType, spinnerStatus;
    ...
    private TextView tvTotalOrders, tvCustomerSince;
    ...
    private void filterUsers(String filter) {
        ...
        for (User user : userList) {
            if (filter.equals("all")) {
                ...
                filteredUserList.add(user);
            } else if (filter.equals("staff") && ("staff".equalsIgnoreCase(user.getRole()) || "admin".equalsIgnoreCase(user.getRole()))) {
                filteredUserList.add(user);
            }
        }
    ...
    private void showEditUserForm(User user) {
        ...
        spinnerUserType.setText(user.getRole(), false);
    ...
    private void showUserDetail(User user) {
        ...
        tvDetailUserType.setText(user.getRole());
    ...
    private void saveUser() {
        ...
        if (selectedUser == null) {
            // Create new user
            createNewUser(fullName, email, phone, userType);
        } else {
            // Update existing user
            updateUser(fullName, email, phone, userType, status);
        }
    }

    private void createNewUser(String fullName, String email, String phone, String userType) {
    ...
    private void updateUser(String fullName, String email, String phone, String userType, String status) {
    ...
    private void saveUserToFirestore(User user) {
        ...
        db.collection("users").document(user.getId())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(UserManageActivity.this, "User saved successfully", Toast.LENGTH_SHORT).show();
                        showUserList();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
